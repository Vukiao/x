...
if (process.argv.length < 8) {
  console.clear();
  console.log(`\n${colored(colors.COLOR_BRIGHT_RED, '                               ADUGAY BROWSER NEW UPDATE 2025')}`);
  console.log('');
  console.log(colored(colors.COLOR_CYAN, "                                        t.me/nmcutii"));
  console.log('');
  console.log(`${colored(colors.COLOR_BRIGHT_YELLOW, '                                         21 April, 2025', true)}\n`);
  console.log('                          -------------------------------------------');
  console.log(`
...
setTimeout(function () {
  exec("pkill -f flood.js", (err, stdout, stderr) => {
    if (err) {
